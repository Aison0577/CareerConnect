...
import AboutView from '../cards/AboutView'

function About() {
  return (
    <section className='py-16'>
        <div className='adjust'>
            <h1 className='font-poppins font-bold text-2xl md:text-3xl lg:text-4xl text-center mb-10'>Why choose <span className='text-blue-800'>CareerConenct.</span></h1>
